      ...
      homeManagerModules = {
        dude-agent =
          ...
          config = lib.mkIf cfg.enable {
            ...
            systemd.user.services.dude-agent = {
              Unit = {
                ...
                After = [ "network.target" ]
                  ++ lib.optional (cfg.obsidianSync.enable && cfg.obsidianSync.separateService) "obsidian-sync.service";
                Wants = lib.optional (cfg.obsidianSync.enable && cfg.obsidianSync.separateService) "obsidian-sync.service";
                StartLimitBurst = "5";
              ...
              Service = {
                ...
                ExecStopPost = lib.optional (cfg.obsidianSync.enable && !cfg.obsidianSync.separateService)
                  "-${pkgs._1password-cli}/bin/op run --env-file ${cfg.opvarsFile} -- ob sync --path ${cfg.obsidianSync.vaultPath}";
            ...
            systemd.user.services.obsidian-sync = lib.mkIf (cfg.obsidianSync.enable && cfg.obsidianSync.separateService) {
              Unit = {

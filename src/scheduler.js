...
const getPaths = () => {
  ...
  return {
    configDir,
    scheduleFile: path.join(configDir, "schedule.json"),
    logFile: path.join(configDir, "agent.log"),
    sessionMapFile: path.join(configDir, "session-map.json"),
  };
};
